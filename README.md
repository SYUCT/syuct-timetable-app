...
当前版本 **0.2.17-alpha1**：课前通知摘要显示开课时间和教室位置；岛短文本为课程名前四字。完整课程详情页、课前15分钟提醒和“闹钟和提醒权限”入口保持可用。厂商岛实际效果仍由手机系统决定，线上版本以 Releases 为准。详见 [UPDATE-0.2.17.md](UPDATE-0.2.17.md) 和 [NOTICE-LAYOUT-REVIEW.md](NOTICE-LAYOUT-REVIEW.md)。

## 使用

1. 从本仓库 Releases 下载已发布的 APK，在安卓手机安装。本次本地构建包名为 `SYUCT-Timetable-0.2.17-alpha1.apk`。设置中可点击「检测更新」。
