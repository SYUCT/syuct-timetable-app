...
run(path.join(bt,'aapt2'),['link','--auto-add-overlay','-I',android,'--manifest',path.join(out,'AndroidManifest.xml'),'-R',path.join(out,'res.zip'),'-A',path.join(root,'app/src/main/assets'),'--java',path.join(out,'generated'),'--min-sdk-version','26','--target-sdk-version','35','--version-code','4','--version-name','0.2.2-alpha1','-o',path.join(out,'resources.apk')]);
